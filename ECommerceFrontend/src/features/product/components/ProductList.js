...
export default function ProductList() {
  ...
  return (
    <div className="shop-page">
      <div className="py-8 bg-gray-100 header">
      ...
      <div className="container py-8 mx-auto">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-4">
          {products.map((product, index) => (
            <div key={index} className="p-4 bg-white rounded-lg shadow product">
              <img
              ...
              <p className="text-green-600">-{product.discountPercentage}%</p>
              <button className="px-4 py-2 mt-2 text-white bg-black rounded">
                Add to cart
              </button>
            </div>
          ))}
        ...
        <div className="mt-8 text-center">
          <button className="px-6 py-3 text-white bg-gray-800 rounded">
            Show more
          </button>
        </div>
      </div>
